...
(function(c){
	c.address=function(){
		...
		var L=function(){
			var a=i.href.indexOf("#");return a!=-1?t(i.href.substr(a+1),k):"";
		};
		var u=function(){
			return E()?U():L();
		};
		...
		var K="hashchange";
		var W="change";
		var X="internalChange";
		var Y="externalChange";
		var n=true;
		var k=false;
		var d={
			autoUpdate:n,crawlable:k,history:n,strict:n,wrap:k
		};
		var D=c.browser;
		var A=parseFloat(D.version);
		var w=!c.support.opacity;
		var B=D.webkit||D.safari,j=function(){
			try{
		...
		var F="on"+K in j;
		var l,J=c("script:last").attr("src");
		var Z=J?J.indexOf("?"):-1;
		var P=o.title;
		var x=k;
		var aa=k;
